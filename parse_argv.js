...
module.exports = function (cmd) {
  if (!argv) {
    argv = program.version(pkg.version, '-v, --version')
      .option('-r, --registry [registry]', 'registry url, default is ' + config.rednpmRegistry)
      .option('-w, --registryweb [registryweb]', 'web url, default is ' + config.rednpmHost)
  ...
  argv.registryweb = argv.registryweb || config.rednpmHost;
